 ...
 */
@Component
@RocketMQMessageListener(topic = "topic_test", selectorExpression = "demo_1", consumerGroup = "consumer_group_1")
public class RocketMQConsumer4Demo1 implements RocketMQListener<String> {
